              ...
              <div class="container">
                <div class="row align-items-center">
                  <div class="col-sm-12 col-md-8 col-lg-8">
                    <h2>
                      <app-translate tKey="resources.hero.title" />
                    </h2>
                    <p>
                      <app-translate tKey="resources.hero.text" />
                    </p>
            ...
            <div class="overlay">
              <div class="container">
                <div class="row align-items-center">
                  <div class="col-sm-12 col-md-8 col-lg-8">
                    <h2>
                      <app-translate tKey="resources.hero.title1" />
                    </h2>
                    <p>
                      <app-translate tKey="resources.hero.text1" />
                    </p>
                    ...
                    <form id="pwa-form" onSubmit={this.handleSubmit.bind(this)} novalidate={true}>
                      ...
                      <div class="center">
                        <button name="submit" type="submit" class="btn btn-primary" disabled={this.isDisabled}>
                          <app-translate tKey="resources.form.button.send" />
                        </button>
                      </div>
                    </form>
                  </div>
          ...
          <div class="container">
            <section id="downloadinfo" class="downloadinfo">
              <div class="downloadinfo--header center">
                <h2>
                  <app-translate tKey="resources.downloadinfo.title" />
                </h2>
                <p>
                  <app-translate tKey="resources.downloadinfo.subtitle" />
                </p>
              </div>
            </section>
            <section class="text-img-container left-side">
              ...
              <div class="text-img-container-text">
                <ul>
                  <li>
                    <p>
                      <app-translate tKey="resources.downloadinfo.list.first" />
                    </p>
                  </li>
                  <li>
                    <p>
                      <app-translate tKey="resources.downloadinfo.list.second" />
                    </p>
                  </li>
                  <li>
                    <p>
                      <app-translate tKey="resources.downloadinfo.list.third" />
                    </p>
                  </li>
                  <li>
                    <p>
                      <app-translate tKey="resources.downloadinfo.list.fourth" />
                    </p>
                  </li>
                </ul>
                <p>
                  <app-translate tKey="resources.downloadinfo.footer" />
                </p>
              </div>
            </section>
          </div>
        ...
        {this.formSubmitted ? (
          <div class="container">
            <section id="thankyou" class="text-img-container left-side">
              ...
              <div class="text-img-container-text">
                <h2>
                  <app-translate tKey="resources.enjoy" />
                </h2>
                <h3>
                  <app-translate tKey="resources.enjoysub" />
                </h3>
                <p>
                  <app-translate tKey="resources.thanks" />
                </p>
