          ...
          <div class="card-container">
            <div class="card-image mobilemeasures">
              <div class="row card-image-row">
                <app-img src="/assets/apps/mobilemeasures/graphic-example-1.webp" class="behind-left" alt="mobile measures app screenshot" />
                <app-img src="/assets/apps/mobilemeasures/graphic-example-2.webp" class="front-center" alt="mobile measures app screenshot" />
                <app-img src="/assets/apps/mobilemeasures/graphic-example-3.webp" class="behind-right" alt="mobile measures app screenshot" />
              </div>
