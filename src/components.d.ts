...
export namespace Components {
  ...
  interface AppHeroHomeAttributes extends StencilHTMLAttributes {
    'textNoWrap'?: boolean;
  }
...
declare global {
  interface StencilElementInterfaces {
    ...
    'AppHeroHome': Components.AppHeroHome;
  ...
  interface StencilIntrinsicElements {
    ...
    'app-hero-home': Components.AppHeroHomeAttributes;
  ...
  interface HTMLAppHeroHomeElement extends Components.AppHeroHome, HTMLStencilElement {}
